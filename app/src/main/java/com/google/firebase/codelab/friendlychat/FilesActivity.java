...
public class FilesActivity extends AppCompatActivity implements
    ...
    private static final String TAG = "Storage#FilesActivity";
        ...
        photoRef.putFile(fileUri)
                ...
                .addOnFailureListener(this, new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception exception) {
                        ...
                        // [START_EXCLUDE]
                        hideProgressDialog();
                        Toast.makeText(FilesActivity.this, "Error: upload failed",
    ...
    private void launchCamera() {
        ...
        if (!EasyPermissions.hasPermissions(this, perm)) {
            EasyPermissions.requestPermissions(this, "rationale_storage",
